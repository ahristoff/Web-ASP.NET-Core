...
namespace Camera.Data.Migrations
{
    ...
    [Migration("20181120131857_InitializeCamera")]
    partial class InitializeCamera
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Camera.Data.Models.Camera", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Camera.Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("Camera.Data.Models.Camera", b =>
                {
                    b.HasOne("Camera.Data.Models.User", "User")
                        .WithMany("Cameras")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Camera.Data.Models.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
